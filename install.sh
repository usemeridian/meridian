...
TMP_DIR="$(mktemp -d)"
FORCE=false
KIT_DEST="$HOME/.claude/meridian"
VERSION_FILE="$KIT_DEST/.meridian-version"
...
echo ""
echo "Meridian — Installing${VERSION:+ (${VERSION})}..."
...
if ! MERIDIAN_NEW_VERSION="$NEW_VERSION" MERIDIAN_OLD_VERSION="$INSTALLED_VERSION" \
