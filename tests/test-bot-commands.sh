...
## Meridian — Bot commands implementation
...
{
  "name": "Nick Weber",
  "meridian_version": "1.8.27",
  "last_active": "2026-03-12T15:00:00Z",
  "personas": ["engineering"]
}
EOF

export MERIDIAN_TEAM_CONTEXT_DIR="$TEAM_DIR"
...
export MERIDIAN_SIGNALS_DIR="$SIGNALS_DIR"
...
if echo "$RESULT" | grep -q "Meridian Bot"; then
...
if echo "$RESULT" | grep -q "Meridian v"; then
