...
export MERIDIAN_SIM_FIXTURES="$SCRIPT_DIR/simulation/fixtures/signals/intercom"

PULL_OUTPUT=$(node "$SCRIPT_DIR/bin/meridian.js" pull intercom --since 2026-02-20 2>&1) || true
...
SIGNAL_FILE="$TEST_HOME/.claude/meridian/signals/intercom/${TODAY_DATE}.md"
...
echo ""
echo "Analysis:"
ANALYSIS_TEST=$(MERIDIAN_SIMULATE=1 MERIDIAN_SIM_FIXTURES="$SCRIPT_DIR/simulation/fixtures/signals/intercom" node -e "
const intercom = require('$SCRIPT_DIR/bin/connectors/intercom');
...
echo ""
echo "Tag Filtering:"
TAG_FILTER_TEST=$(MERIDIAN_SIMULATE=1 MERIDIAN_SIM_FIXTURES="$SCRIPT_DIR/simulation/fixtures/signals/intercom" node -e "
const intercom = require('$SCRIPT_DIR/bin/connectors/intercom');
