...
## UX Consistency
- report-service branding flag (PR #2466) introduces a new toggle pattern. Existing settings pages use dropdowns for similar controls. Inconsistency risk if shipped as-is.
...
## Design Debt
- 3 different date picker components in use across web-api, data-pipeline, and report-service. Consolidation to shared component overdue.
