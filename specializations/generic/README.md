...
The AI will update `.ai-memory/state.md` and append to the journal. Do NOT update `~/.ai-memory/global.md` at session end — it is rebuilt automatically by `meridian status`.
