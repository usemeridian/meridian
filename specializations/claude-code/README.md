...
This directory contains everything needed to wire Meridian into Claude Code specifically.
...
cp ~/.claude/meridian/templates/repo-state.md .claude/team-state.md    # Shared team context (committed)
cp ~/.claude/meridian/templates/repo-state.md .claude/personal-state.md # Personal context (gitignored)

# Add session protocol to repo CLAUDE.md
cat ~/.claude/meridian/specializations/claude-code/CLAUDE.md-repo-fragment.md >> CLAUDE.md
