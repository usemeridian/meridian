...
[![CI](https://github.com/usemeridian/meridian/actions/workflows/ci.yml/badge.svg)](https://github.com/usemeridian/meridian/actions/workflows/ci.yml)
[![License: Apache 2.0](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](LICENSE)
[![npm](https://img.shields.io/npm/v/meridian-dev)](https://www.npmjs.com/package/meridian-dev)
...
- **Searchable history** — `meridian search-journals "auth refactor"`
...
- **Slack bot** — anyone on the team asks `@meridian` and gets answers from the decision trail
...
meridian pull --all        # All configured channels
```
...
- Bug reports and feature requests via [issues](https://github.com/usemeridian/meridian/issues)
